...
<script>
	$(document).ready(function(){
		...
		var year = $("#pettyyearYV").html();
		
		var oTable = $('#pettyYear_table').dataTable( {
		"bProcessing": true,
		"bServerSide": true,
		"bPaginate": true,
		"bDestroy":true,
		...
		"sAjaxSource": "pettyYearController.php?year="+year,
...
<div style="display: none;" id="pettyyearYV"><?php echo $_GET['year'];?></div>


		<table id="pettyYear_table" >
			<thead>
