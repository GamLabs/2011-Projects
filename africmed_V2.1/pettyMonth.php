...
<script>
	$(document).ready(function(){
		...
		//});
		var month = $("#pettymonthV").html();
		var year = $("#pettymonthYV").html();
		
		var oTable = $('#pettyMonth_table').dataTable( {
		"bProcessing": true,
		"bServerSide": true,
		"bPaginate": true,
		"bDestroy":true,
		...
		"sAjaxSource": "pettyMonthController.php?month="+month+"&year="+year ,
...
<div style="display: none;" id="pettymonthV"><?php echo $_GET['month'];?></div>
<div style="display: none;" id="pettymonthYV"><?php echo $_GET['year'];?></div>


		<table id="pettyMonth_table" >
			<thead>
