...
<script>
	$(document).ready(function(){
		...
		$('#cashDetail_table').dataTable( {
		"bProcessing": true,
		"bServerSide": true,
		"bPaginate": true,
		"bJQueryUI": true,
		"sAjaxSource": "cashdetail_processing.php",
		"iDisplayLength": 20,
		...
		"fnFooterCallback": function ( nRow, aaData, iStart, iEnd, aiDisplay ) {
            ...
            nCells[3].innerHTML = parseInt(total );
            nCells[4].innerHTML = parseInt(paid );
