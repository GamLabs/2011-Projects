...
<script>
	$(document).ready(function(){
		...
		//});
		var date = $("#labSalesdateV").html();
		
		
		var oTable = $('#labSales_table').dataTable( {
		"bProcessing": true,
		"bServerSide": true,
		"bPaginate": true,
		"bDestroy":true,
		...
		"sAjaxSource": "labSalesControllerSource.php?date="+date ,
...
<div style="display: none;" id="labSalesdateV"><?php echo $_GET['date'];?></div>



		<table id="labSales_table" >
			<thead>
