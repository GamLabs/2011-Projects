...
foreach ($Fetch as $record){
	...
	echo'"   <a id=\"deletePnumberTable\" href=\"#\" style=\"text-decoration:none;color:red;font-size:19;\">Delete   <a id=\"searchPnumberTable\" href=\"#\" style=\"text-decoration:none;color:red;font-size:19;\">Edit  </a>',$record['pnumber'],'", "',$record['fname'],'","',$record['lname'],'","',$record['dob'],'","',$record['phone'],'';
	$count++;
	if($rrr!=$count){
		echo '"],';
	}else{
