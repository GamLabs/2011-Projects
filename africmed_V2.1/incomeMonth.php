...
<script>
	$(document).ready(function(){
		...
		//});
		var month = $("#incomemonthV").html();
		var year = $("#incomemonthYV").html();
		
		var oTable = $('#incomeMonth_table').dataTable( {
		"bProcessing": true,
		"bServerSide": true,
		"bPaginate": true,
		"bDestroy":true,
		...
		"sAjaxSource": "incomeMonthController.php?month="+month+"&year="+year ,
...
<div style="display: none;" id="incomemonthV"><?php echo $_GET['month'];?></div>
<div style="display: none;" id="incomemonthYV"><?php echo $_GET['year'];?></div>


		<table id="incomeMonth_table" >
			<thead>
