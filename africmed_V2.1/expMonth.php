...
<script>
	$(document).ready(function(){
		...
		//});
		var month = $("#expmonthV").html();
		var year = $("#expmonthYV").html();
		
		var oTable = $('#expMonth_table').dataTable( {
		"bProcessing": true,
		"bServerSide": true,
		"bPaginate": true,
		"bDestroy":true,
		...
		"sAjaxSource": "expMonthController.php?month="+month+"&year="+year ,
...
<div style="display: none;" id="expmonthV"><?php echo $_GET['month'];?></div>
<div style="display: none;" id="expmonthYV"><?php echo $_GET['year'];?></div>


		<table id="expMonth_table" >
			<thead>
