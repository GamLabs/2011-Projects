...
<script>
	$(document).ready(function(){
		...
		var get = $("#displayGetDataForPharS").attr('value');
		
		
		var oTable = $('#pharSales_table').dataTable( {
		"bProcessing": true,
		//"bServerSide": true,
		"bPaginate": true,
		"bDestroy":true,
		...
		"sAjaxSource": "pharSalesControllerSource.php?"+get ,
...
<div style="display: none;" id="displayGetDataForPharS" value="<?php getParams();?>"></div>





		<table id="pharSales_table" >
			<thead>
