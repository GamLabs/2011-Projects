...
<script>
	$(document).ready(function(){
		...
		//});
		var comp = $("#displayInsureComp").html();
		var month = $("#displayInsureMonth").html();
		var year = $("#displayInsureYear").html();
		
		$('#DInsureBills_table').dataTable( {
		"bProcessing": true,
		"bServerSide": true,
		"bPaginate": true,
		"bDestroy":true,
		...
		"sAjaxSource": "displayInsuranceBillsSummary_Controller.php?month="+month+"&year="+year+"&comp="+comp ,
...
<div style="display: none;" id="displayInsureComp"><?php echo $_GET['comp'];?></div>
<div style="display: none;" id="displayInsureMonth"><?php echo $_GET['month'];?></div>
<div style="display: none;" id="displayInsureYear"><?php echo $_GET['year'];?></div>


		<table id="DInsureBills_table" >
			<thead>
				<tr style="white-space:nowrap;vertical-align:top" class="ui-widget-header">
