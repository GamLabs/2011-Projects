...
<script>
	$(document).ready(function(){
		...
		var year = $("#expyearYV").html();
		
		var oTable = $('#expYear_table').dataTable( {
		"bProcessing": true,
		"bServerSide": true,
		"bPaginate": true,
		"bDestroy":true,
		...
		"sAjaxSource": "expYearController.php?year="+year,
...
<div style="display: none;" id="expyearYV"><?php echo $_GET['year'];?></div>


		<table id="expYear_table" >
			<thead>
