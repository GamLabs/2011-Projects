...
<script>
	$(document).ready(function(){
		...
		var date = $("#shiftCashDate").html();
		var shift = $("#shiftCashShift").html();
		
		$('#shitSales_table').dataTable( {
		"bProcessing": true,
		"bServerSide": true,
		"bPaginate": true,
		"bDestroy":true,
		...
		"sAjaxSource": "shiftSales_Controler.php?date="+date+"&shift="+shift,
		"fnFooterCallback": function ( nRow, aaData, iStart, iEnd, aiDisplay ) {
            ...
            nCells[6].innerHTML = 'D'+parseInt(total );
...
<div style="display: none;" id="shiftCashDate"><?php echo $_GET['date'];?></div>
<div style="display: none;" id="shiftCashShift"><?php echo $_GET['shift'];?></div>


		<table id="shitSales_table" >
			<thead>
