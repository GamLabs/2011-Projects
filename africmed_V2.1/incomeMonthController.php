...
require_once 'includes/receptionFunctions.php';
	 ...
	 */
	$aColumns = array( 'date','incomeCode', 'name', 'comment','payment_method','cheque_number','amount' );
	...
	{
		$col = count($aColumns);
		$sWhere = "WHERE $nf month(date) = $month and year(date) = $year and ";
