...
<script>
	$(document).ready(function(){
		...
		//});
		var date = $("#expdateV").html();
		
		var oTable = $('#expDate_table').dataTable( {
		"bProcessing": true,
		"bServerSide": true,
		"bPaginate": true,
		"bDestroy":true,
		...
		"sAjaxSource": "expDateController.php?date="+date ,
...
<div style="display: none;" id="expdateV"><?php echo $_GET['date'];?></div>


		<table id="expDate_table" >
			<thead>
