...
<script>
	$(document).ready(function(){
		...
		//});
		var date = $("#incomedateV").html();
		
		var oTable = $('#incomeDate_table').dataTable( {
		"bProcessing": true,
		"bServerSide": true,
		"bPaginate": true,
		"bDestroy":true,
		...
		"sAjaxSource": "incomeDateController.php?date="+date ,
...
<div style="display: none;" id="incomedateV"><?php echo $_GET['date'];?></div>


		<table id="incomeDate_table" >
			<thead>
