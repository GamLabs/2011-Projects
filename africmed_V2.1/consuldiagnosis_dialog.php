...
$("#investigation").change(function(){
	...
	$("#addInvest").click(function(){
		if($("#investigationType").val() !="Select One"){
			$.post('check.php',{'investPnumber':$('#pnumber').val(),'investCategory': $("#investigation").val(),'investType': $("#investigationType option:selected").text(),'investFor':$("#investigationFor").val()},function(data) {
