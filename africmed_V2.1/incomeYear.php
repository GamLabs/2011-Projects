...
<script>
	$(document).ready(function(){
		...
		var year = $("#incomeyearYV").html();
		
		var oTable = $('#incomeYear_table').dataTable( {
		"bProcessing": true,
		"bServerSide": true,
		"bPaginate": true,
		"bDestroy":true,
		...
		"sAjaxSource": "incomeYearController.php?year="+year,
...
<div style="display: none;" id="incomeyearYV"><?php echo $_GET['year'];?></div>


		<table id="incomeYear_table" >
			<thead>
