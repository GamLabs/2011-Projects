...
<![endif]-->
  ...
  <?php print $scripts ?>
  <script src="/julafinance/sites/all/themes/marinelli/jquery.marquee.js" type="text/javascript"></script>
</head>
...
<?php } ?>
      ...
      <?php print '<div id="submenu">' ?>
        ...
        <?php endif; ?>
<div id="marquee" style="background: blue; font-size:20px">
    EXCHANGE RATES: |EURO = 40.00| |US-DOLLAR = 40.00| |GB-POUND = 40.00| |CHF = 40.00| |EURO = 40.00|
</div>
